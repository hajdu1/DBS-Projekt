...
class LikvidatorIssues(models.Model):
    ...
    liquidation_start_date = models.DateTimeField()
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField()
...
class OrPodanieIssueDocuments(models.Model):
    ...
    ruz_deposit_date = models.DateTimeField(blank=True, null=True)
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField()
...
class ZnizenieImaniaIssues(models.Model):
    ...
    resolution_store_date = models.DateTimeField(blank=True, null=True)
    first_ov_released_date = models.DateTimeField(blank=True, null=True)
