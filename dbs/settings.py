...
SECRET_KEY = 'b%6dj4g#z+r@tvn_)0v)_m9s%1=o9k_1v%h^eh00drba5uj(1!'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

# added allowed hosts (local and azure server)
ALLOWED_HOSTS = ['127.0.0.1', 'fiit-dbs-xhajduj-app.azurewebsites.net']
